...
namespace UnlimitedThreatScale
{
    public class UncappedWealthCurve : SimpleCurve
    {
        ...
        public static UncappedWealthCurve PointsFactorForColonyMutantsCurve = new UncappedWealthCurve((SimpleCurve)typeof(StorytellerUtility).Field("PointsFactorForColonySubhumanCurve").GetValue(null));
